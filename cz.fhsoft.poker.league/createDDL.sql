...
CREATE TABLE PL_TOURNAMENT (ID INTEGER NOT NULL, DEADLINE INTEGER, DEFAULTBUYIN INTEGER, DESCRIPTION VARCHAR(255), MAXPLAYERS INTEGER, MINPLAYERS INTEGER, NAME VARCHAR(255), OBSOLETE TINYINT(1) default 0, TOURNAMENTEND DATETIME, TOURNAMENTSTART DATETIME, COMPETITION_ID INTEGER, DEFAULTPRIZEMONEYRULESET_ID INTEGER, PRIMARY KEY (ID))
