...
CREATE TABLE PL_COMPETITION (ID INTEGER NOT NULL, DEFAULTBUYIN INTEGER, DEFAULTMAXPLAYERS INTEGER, DEFAULTMINPLAYERS INTEGER, DEFAULTTOURNAMENTANNOUNCEMENTLEAD INTEGER, DESCRIPTION VARCHAR(255), ENDDATE DATE, NAME VARCHAR(255), OBSOLETE TINYINT(1) default 0, STARTDATE DATE, DEFAULTPRIZEMONEYRULESET_ID INTEGER, PRIMARY KEY (ID))
