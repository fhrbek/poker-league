...
CREATE TABLE PL_SETTINGS (ID INTEGER NOT NULL, ADMINPASSWORD VARCHAR(255), DEFAULTTIMEZONE VARCHAR(255), PRIMARY KEY (ID))
...
CREATE TABLE PL_COMPETITION (ID INTEGER NOT NULL, DEFAULTBUYIN INTEGER, DEFAULTMAXPLAYERS INTEGER, DEFAULTMINPLAYERS INTEGER, DEFAULTTOURNAMENTANNOUNCEMENTLEAD INTEGER, DESCRIPTION VARCHAR(255), ENDDATE DATE, MINIMALATTENDANCE INTEGER, NAME VARCHAR(255), OBSOLETE TINYINT(1) default 0, STARTDATE DATE, DEFAULTPRIZEMONEYRULESET_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE PL_TOURNAMENT (ID INTEGER NOT NULL, DEFAULTBUYIN INTEGER, DESCRIPTION VARCHAR(255), MAXPLAYERS INTEGER, MINPLAYERS INTEGER, NAME VARCHAR(255), OBSOLETE TINYINT(1) default 0, TOURNAMENTANNOUNCEMENTLEAD INTEGER, TOURNAMENTEND DATETIME, TOURNAMENTSTART DATETIME, COMPETITION_ID INTEGER, DEFAULTPRIZEMONEYRULESET_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE PL_INVITATION (ID INTEGER NOT NULL, OBSOLETE TINYINT(1) default 0, ORDINAL INTEGER, REPLY VARCHAR(255), UUID VARCHAR(255), PLAYER_ID INTEGER, TOURNAMENT_ID INTEGER, PRIMARY KEY (ID))
